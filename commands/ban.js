...
module.exports = {
    ...
    run: async (bot, message, args) => {
        ...
        if(member.permissions.has(Permissions.FLAGS.BAN_MEMBERS)) return bot.utils.replyTemp(message,"You can't kick another staff member!",isSlashCommand,bot.config.deleteTimer);
